...
private:
    ...
    XRPAmount dropsCreated_ = 0;
    XRPAmount dropsVBCCreated_ = 0;

    STArray feeShareTakers_;
...
public:
    ...
    void
    createXRP (XRPAmount const& drops);

    void
    createVBC (XRPAmount const& drops);

    STArray&
    peekFeeShareTakers () { return feeShareTakers_; }
