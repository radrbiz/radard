...
bool transResultInfo (TER code, std::string& token, std::string& text)
{
    ...
    TxResultInfo const results[] =
    {
        ...
        { temBAD_SEND_XRP_MAX,      "temBAD_SEND_VRP_MAX",      "Malformed: Send max is not allowed for VRP to VRP."            },
        { temBAD_SEND_XRP_NO_DIRECT,"temBAD_SEND_VRP_NO_DIRECT","Malformed: No Radar direct is not allowed for VRP to VRP."     },
        { temBAD_SEND_XRP_PARTIAL,  "temBAD_SEND_VRP_PARTIAL",  "Malformed: Partial payment is not allowed for VRP to VRP."     },
