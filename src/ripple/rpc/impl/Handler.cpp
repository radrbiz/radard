...
//      {   "profile",              byRef (&doProfile),             Role::USER,  NEEDS_CURRENT_LEDGER  },
    ...
    {   "proposal_info",        byRef (&doProposalInfo),        Role::USER,  NEEDS_CURRENT_LEDGER  },
    {   "account_vote",         byRef (&doAccountVote),         Role::USER,  NEEDS_CURRENT_LEDGER  },
    {   "vote_counting",        byRef (&doVoteCounting),        Role::USER,  NEEDS_CURRENT_LEDGER  },
